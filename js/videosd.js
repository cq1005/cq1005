...
function WMXZ( url ){$( '#PLAYERS' ).attr( 'src', decodeURIComponent( decodeURIComponent( url ) ) ).show();  }
...
function flss(){
var flss = getId('url')?getId('url'):getId('f')?getId('f'):"http://cctvalih5ca.v.myalicdn.com/live/cctv1_2/index.m3u8";
