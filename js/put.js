...
var src6 =  './jw.htm?&f=' + kfss;
var src7 =  './xg.htm?&f=' + kfss;
...
ftss[0]  =cfts5 + "jspdhd" + mnf3;//纪实频道;
ftss[1]  =cfts5 + "cctv1hd" + mnf3;//cctv1;
ftss[2]  =cfts5 + "cctv2" + mnf1;//cctv2;
ftss[3]  =cfts5 + "cctv3hd" + mnf3;//cctv3;
ftss[4]  =cfts5 + "cctv4" + mnf1;//cctv4
ftss[5]  =cfts5 + "cctv5" + mnf1;//cctv5
ftss[6]  =cfts5 + "cctv6hd" + mnf3;//cctv6;
ftss[7]  =cfts5 + "cctv7" + mnf1;//cctv7;
ftss[8]  =cfts5 + "cctv8hd" + mnf3;//cctv8;
ftss[9]  =cfts5 + "cctvjl" + mnf1;//cctv9;          
ftss[10] =cfts5 + "cctv10hd" + mnf1;//cctv10;
ftss[11] =cfts5 + "cctv11" + mnf1;//cctv11;
ftss[12] =cfts5 + "cctv12" + mnf1;//cctv12;
ftss[13] =cfts5 + "cctvxw" + mnf1;//cctv13;
ftss[14] =cfts5 + "cctvsehd" + mnf3; //少儿;
ftss[15] =cfts5 + "cctvyy" + mnf1; //音乐;
ftss[16] =cfts5 + "bjws" + mnf1; //北京卫视
ftss[17] =cfts5 + "cctv17" + mnf1;//cctv17;
ftss[18] ="http://cclive2.aniu.tv/live/anzb.m3u8";//老左;
ftss[19] =cfts5 + "dycjhd" + mnf3;  //第一财经
ftss[20] =cfts5 + "zgqx" + mnf1;    //气象;
ftss[21] =cfts5 + "dsjpdhd" + mnf3; //东方影视
ftss[22] =cfts5 + "shanxiws" + mnf1;    //山西卫视;
ftss[23] =cfts5 + "scws" + mnf1;    //四川卫视;
ftss[24] =cfts5 + "hddfws" + mnf3;  //东方卫视
ftss[25] =cfts5 + "hbwshd" + mnf3;  //湖北卫视
ftss[26] =cfts5 + "jswshd" + mnf3;  //江苏卫视
ftss[27] =cfts5 + "tjwshd" + mnf3;  //天津卫视
ftss[28] =cfts5 + "gzws" + mnf1;    //贵州卫视
ftss[29] =cfts5 + "jlws" + mnf1;    //吉林卫视
ftss[30] =cfts5 + "sdwshd" + mnf3;  //山东卫视
ftss[31] =cfts5 + "hnwshd" + mnf3;  //湖南卫视
ftss[32] =cfts5 + "btws" + mnf1;    //兵团卫视
ftss[33] =cfts5 + "lnwshd" + mnf3;  //辽宁卫视
ftss[34] =cfts5 + "hljwshd" + mnf3; //黑龙江卫视
ftss[35] =cfts5 + "qjshd" + mnf3;//全纪实
ftss[36] =cfts5 + "ahwshd" + mnf3;  //安徽卫视
ftss[37] =cfts5 + "szwshd" + mnf3;//深圳卫视
ftss[38] =cfts5 + "dnwshd" + mnf3;//东南卫视
ftss[39] =cfts5 + "ynws" + mnf1;//云南卫视
ftss[40] =cfts5 + "qhws" + mnf1;//青海卫视
ftss[41] =cfts5 + "hbws" + mnf1;//河北卫视
ftss[42] =cfts5 + "hnws" + mnf1;//河南卫视
ftss[43] =cfts5 + "sxws" + mnf1;//陕西卫视
