...
<a>~~~~~~~~~~~~~~~</a>
<h1 onClick="javascript:ShowMenu(this,0)"><a href="javascript:void(0)">+tv</a></h1>
<span class="yes"  scroll="yes">
<?php
header('Access-Control-Allow-Origin:*');
$surl= "../st/d/tv.php";
include_once(iconv("gbk","UTF-8",$surl));
//include $_SERVER['DOCUMENT_ROOT'].$surl;
//include $surl;
//require_once($surl);
?>
</span>
